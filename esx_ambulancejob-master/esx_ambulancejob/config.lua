...
Config.EarlyRespawnTimer          = 60000 * 3.0  -- time til respawn is available
Config.BleedoutTimer              = 60000 * 10.0 -- time til the player bleeds out
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Vehicles = {
			{
				Spawner = vector3(0.903, -604.37, 43.1928),
				InsideShop = vector3(0.629, -585.93, 43.1936),
