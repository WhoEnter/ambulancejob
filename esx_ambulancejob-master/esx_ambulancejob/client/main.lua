...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
	...
	if itemName == 'medkit' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			TaskPlayAnim(playerPed, lib, anim, 8.0, -8.0, -1, 0, 0, false, false, false)
              exports['progressBars']:startUI(10100, "Uygulanıyor...")
			Citizen.Wait(500)
			...
			exports['mythic_notify']:DoHudText('muhittin', 'Medkit kullandın..', 3000)
		end)
	...
	elseif itemName == 'bandage' then
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:DoHudText('muhittin', 'Bandaj kullandın..', 3000)
		end)
	end
end)
...
function StartDistressSignal()
	Citizen.CreateThread(function()
		...
		--	AddTextComponentSubstringPlayerName(('Sinyal Yollamak Icin : ~y~F3 > EMS BILDIRIM GONDER~s~'))
...
function SendDistressSignal()
	...
	exports['mythic_notify']:DoHudText('muhittin', _U('distress_sent'), 4000)
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		local formattedCoords = {
			...
			StopScreenEffect('DeathFailOut')
			local playerPed = PlayerPedId()
			SetEntityCoords(playerPed, 315.270, -566.60, 43.2774)
			SetEntityHeading(playerPed, 133.58)
			local playerPed = PlayerPedId()
			exports['mythic_progbar']:Progress({
				...
				if not cancelled then
					DoScreenFadeIn(1800)
					SetEntityCoords(playerPed,307.096, -594.55, 43.2839)
					ESX.ShowNotification('Tedavi oldun !')
					DeletePed(doctor)
		print('allah')
		end
		end)
...
-- RegisterCommand('mertanneoc', function()
...
RegisterNUICallback('ButtonRevive',function()
	...
	if GetGameTimer() > emsBildirimCd then
		...
		ESX.ShowNotification('Siyal Gönderildi !')
		bakiiii()
		else
			ESX.ShowNotification('5 dakikada bir sinyal atabilirsin !')
			end
		end)		
...
if yarragimiyemert then
	...
	ESX.ShowNotification('Önce Süre Bitmeli !')
	end
end)
